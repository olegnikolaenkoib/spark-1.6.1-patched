...
// import org.apache.spark.ml.tree.DecisionTreeModelReadWrite.{SplitData, NodeData}
...
private[ml] object EnsembleModelReadWrite {
  ...
  def loadImpl(
    ...
    val dataPath = new Path(path, "data").toString
//    OuterScopes.addOuterScope(EnsembleNodeData)
...
/**
  ...
  */
private[ml] case class EnsembleNodeData(
                             treeID: Int,
                             nodeData: NodeData)


private[ml] object EnsembleNodeData {
  /**
